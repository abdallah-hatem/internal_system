 ...
 *
 * Copied from the storefront unchanged, deliberately. Every function here is a
 * browser quirk somebody already paid for once — iPadOS reporting itself as a
 * Mac, Firefox refusing a base64url string, Safari giving no push at all until
 * the app is on the home screen. A shorter version written from memory would
 * rediscover them on somebody's phone.
 *
